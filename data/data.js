  ...
  "sections": [
    ...
    },
    {
      ...
      "cards": [
        ...
        {
          "id": "c1-21",
          "title": "추정량의 4대 평가 기준 및 점추정·구간추정 (불편성·효율성·일치성·충족성)",
          "open": false,
          "content": "\n<h4 class='concept-block-h4'>1. 추정량의 4대 바람직한 성질 (불·효·일·충)</h4>\n<div class='concept-keywords-row'>\n  <span class='concept-keyword-label'>🔑 핵심 키워드:</span>\n  <span class='concept-keyword-tag'>불편성(Unbiasedness)</span>\n  <span class='concept-keyword-tag'>효율성(Efficiency)</span>\n  <span class='concept-keyword-tag'>일치성(Consistency)</span>\n  <span class='concept-keyword-tag'>충족성(Sufficiency)</span>\n  <span class='concept-keyword-tag'>MSE(평균제곱오차)</span>\n</div>\n\n<ul class='concept-block-ul'>\n  <li><strong>불편성 (Unbiasedness):</strong> 추정량 $\\hat{\\theta}$의 기댓값이 참 모수 $\\theta$와 일치함. 즉, $E(\\hat{\\theta}) = \\theta$, 편향(Bias) = 0.</li>\n  <li><strong>효율성 (Efficiency):</strong> 모든 불편추정량 중에서 <strong>분산(Variance)이 가장 작은</strong> 성질. 분산이 작을수록 효율적(최소분산 불편추정량 MVUE).</li>\n  <li><strong>일치성 (Consistency):</strong> 표본 크기 $n$이 무한히 커질수록($n \\to \\infty$), 추정량 $\\hat{\\theta}$가 참 모수 $\\theta$에 확률적으로 수렴함.</li>\n  <li><strong>충족성 (Sufficiency):</strong> 모수 $\\theta$에 대해 표본 데이터가 가지고 있는 <strong>모든 정보</strong>를 빠짐없이 추출하여 담고 있는 추정량.</li>\n  <li><strong>평균제곱오차 (MSE):</strong> $MSE(\\hat{\\theta}) = Var(\\hat{\\theta}) + [Bias(\\hat{\\theta})]^2$. 불편추정량인 경우 편향이 0이므로 $MSE = Var$.</li>\n</ul>\n\n<div class='concept-block-note'>\n  💡 <strong>비전공자를 위한 쉬운 비유:</strong> 양궁 과녁 맞추기!<br>\n  - <strong>불편성:</strong> 쏜 화살들의 평균 위치가 정확히 과녁 정중앙(10점)을 향함.<br>\n  - <strong>효율성:</strong> 화살들이 한곳에 아주 조밀하게 옹기종기 모여있음(분산 최소).<br>\n  - <strong>일치성:</strong> 화살을 많이 쏠수록(표본수 $n \\to \\infty$) 점들이 중심점으로 점점 더 정확하게 모여듦.<br>\n  - <strong>충족성:</strong> 과녁의 점수 정보 중 단 1점도 버리지 않고 모두 반영함.\n</div>\n\n<h4 class='concept-block-h4'>2. 4대 성질 3초 비교 테이블</h4>\n<table class='concept-table' style='width:100%; border-collapse:collapse; margin:10px 0;'>\n  <thead>\n    <tr style='background:var(--bg-card-muted);'>\n      <th style='padding:8px; border:1px solid var(--border-color);'>평가 기준</th>\n      <th style='padding:8px; border:1px solid var(--border-color);'>핵심 수식 및 정의</th>\n      <th style='padding:8px; border:1px solid var(--border-color);'>3초 킬러 판별 키워드</th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>불편성</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>$E(\\hat{\\theta}) = \\theta$ (편향 = 0)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>기댓값 = 참 모수</strong></td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>효율성</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>불편추정량 중 $Var(\\hat{\\theta})$ 최소</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>최소 분산</strong></td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>일치성</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>$n \\to \\infty$ 일 때 $\\hat{\\theta} \\to \\theta$</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>표본 크기 증가 시 모수에 수렴</strong></td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>충족성</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>$f(x|\\theta) = g(t|\\theta) h(x)$</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>모수에 대한 모든 정보 포함</strong></td>\n    </tr>\n  </tbody>\n</table>\n\n<div class='concept-block-quiz'>\n  <div class='concept-quiz-q'>⚡ <strong>출제자의 함정 & 자가진단 OX:</strong><br>\n  Q1. 표본평균 $\\bar{X}$는 모평균 $\\mu$의 불편추정량이자 최소분산 불편추정량이다. (O/X)<br>\n  Q2. 평균제곱오차(MSE)는 추정량의 분산과 편향의 합으로 계산된다. (O/X)</div>\n  <div class='concept-quiz-a'>\n  정답: Q1 - <strong>O</strong> (표본평균은 불편성과 효율성을 모두 만족함)<br>\n  Q2 - <strong>X</strong> (MSE는 분산 + <strong>편향의 제곱(Bias²)</strong>입니다. 단순 합이 아님!)\n  </div>\n</div>\n"
        }
      ]
    },
    {
      ...
      "cards": [
        ...
        {
          "id": "c1-22",
          "title": "8대 거리 척도 총정리 (유클리드·맨하탄·체비셰프·마할라노비스·코사인·자카드)",
          "open": false,
          "content": "\n<h4 class='concept-block-h4'>1. 데이터 분석 8대 거리 척도 완전 정복</h4>\n<div class='concept-keywords-row'>\n  <span class='concept-keyword-label'>🔑 핵심 키워드:</span>\n  <span class='concept-keyword-tag'>유클리드($L_2$)</span>\n  <span class='concept-keyword-tag'>맨하탄($L_1$)</span>\n  <span class='concept-keyword-tag'>체비셰프($L_\\infty$)</span>\n  <span class='concept-keyword-tag'>마할라노비스(상관/공분산)</span>\n  <span class='concept-keyword-tag'>코사인(각도/방향)</span>\n  <span class='concept-keyword-tag'>자카드(집합/교집합)</span>\n</div>\n\n<ul class='concept-block-ul'>\n  <li><strong>1) 유클리드 거리 ($L_2$ norm):</strong> 두 점 사이의 최단 직선 거리 (피타고라스 정리: $\\sqrt{\\sum(x_i - y_i)^2}$).</li>\n  <li><strong>2) 맨하탄 거리 ($L_1$ / 시가지 거리):</strong> 바둑판 격자 도로망을 따라 이동하는 거리 (절댓값 차의 합: $\\sum |x_i - y_i|$).</li>\n  <li><strong>3) 체비셰프 거리 ($L_\\infty$):</strong> 각 좌표 성분별 차이 중 <strong>가장 큰 최댓값</strong> (체스 킹의 이동: $\\max_i |x_i - y_i|$).</li>\n  <li><strong>4) 민코우스키 거리 ($L_p$ norm):</strong> $L_1$(맨하탄), $L_2$(유클리드)를 일반화한 $p$차원 노름 거리.</li>\n  <li><strong>5) 마할라노비스 거리 (Mahalanobis):</strong> 변수 간 <strong>상관관계(공분산 행렬 역행렬 $\\Sigma^{-1}$)와 분산</strong>을 모두 고려한 통계적 거리. 변수 간 상관성이 존재할 때 필수!</li>\n  <li><strong>6) 표준화 거리 (Standardized):</strong> 각 변수의 측정 척도(단위) 차이를 보정하기 위해 표준편차로 나눈 유클리드 거리 (상관관계는 미고려).</li>\n  <li><strong>7) 코사인 거리 (Cosine):</strong> $1 - \\text{Cosine Similarity}$. 벡터의 크기(길이)와 무관하게 <strong>사잇각(방향성)</strong>만을 측정. 텍스트/문서 유사도 및 고차원 희소 데이터에 최적.</li>\n  <li><strong>8) 자카드 거리 (Jaccard):</strong> $1 - \\frac{|A \\cap B|}{|A \\cup B|}$. 이진 속성(0/1) 및 집합 간 유사도 측정 (두 객체가 공유하는 특성의 비율).</li>\n</ul>\n\n<h4 class='concept-block-h4'>2. 시험장 3초 킬러 판별식</h4>\n<div class='concept-block-note'>\n  🎯 <strong>상황별 거리 척도 선택 공식:</strong><br>\n  - <strong>변수 간 상관관계 / 공분산 고려</strong> ➔ <strong style='color:var(--brand-dark);'>마할라노비스 거리</strong><br>\n  - <strong>문서 / 텍스트 단어 빈도 / 벡터 사잇각</strong> ➔ <strong style='color:var(--brand-dark);'>코사인 거리</strong><br>\n  - <strong>0과 1의 이진 데이터 / 키워드 집합 유사도</strong> ➔ <strong style='color:var(--brand-dark);'>자카드 거리</strong><br>\n  - <strong>격자 도로망 이동 / 절대 차이 합</strong> ➔ <strong style='color:var(--brand-dark);'>맨하탄 거리 ($L_1$)</strong><br>\n  - <strong>최대 차이 성분 하나만 고려</strong> ➔ <strong style='color:var(--brand-dark);'>체비셰프 거리 ($L_\\infty$)</strong>\n</div>\n\n<div class='concept-block-quiz'>\n  <div class='concept-quiz-q'>⚡ <strong>출제자의 함정 & 자가진단 OX:</strong><br>\n  Q. 표준화 거리는 변수 간 상관관계를 완벽하게 반영하여 거리를 계산한다. (O/X)</div>\n  <div class='concept-quiz-a'>\n  정답: <strong>X</strong> - 표준화 거리는 각 변수의 '분산(척도)'만 보정할 뿐, <strong>변수 간 상관관계(공분산)는 반영하지 못합니다</strong>. 변수 간 상관관계를 고려하는 거리는 오직 <strong>마할라노비스 거리</strong>입니다!\n  </div>\n</div>\n"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "cards": [
        {
          "id": "c2-8",
          "title": "결측값 3대 유형(MCAR·MAR·MNAR) 및 대치법(Hot/Cold Deck·MICE)",
          "open": false,
          "content": "\n<h4 class='concept-block-h4'>1. 결측값 3대 메커니즘 완벽 구분</h4>\n<div class='concept-keywords-row'>\n  <span class='concept-keyword-label'>🔑 핵심 키워드:</span>\n  <span class='concept-keyword-tag'>MCAR (완전 무작위)</span>\n  <span class='concept-keyword-tag'>MAR (무작위)</span>\n  <span class='concept-keyword-tag'>MNAR (비무작위)</span>\n  <span class='concept-keyword-tag'>Hot Deck (현재 데이터)</span>\n  <span class='concept-keyword-tag'>Cold Deck (외부 데이터)</span>\n  <span class='concept-keyword-tag'>MICE (다중대치)</span>\n</div>\n\n<ul class='concept-block-ul'>\n  <li><strong>MCAR (완전 무작위 결측, Missing Completely At Random):</strong> 결측 발생이 모든 관측값 및 결측값과 완전히 무관 (아무런 이유 없는 순수 우연, 예: 기계 일시 오작동).</li>\n  <li><strong>MAR (무작위 결측, Missing At Random):</strong> 결측 발생이 <strong>'다른 관측된 변수'</strong>와는 관련이 있으나, 결측된 <strong>'자기 자신의 값'</strong>과는 무관 (예: 성별에 따라 체중 응답률이 다르지만, 체중이 무거워서 안 적은 것은 아님).</li>\n  <li><strong>MNAR (비무작위 결측, Missing Not At Random):</strong> 결측 발생이 결측된 <strong>'자기 자신의 값'</strong> 때문에 발생함 (예: 고소득자가 자신의 소득 질문에 응답을 기피함).</li>\n</ul>\n\n<h4 class='concept-block-h4'>2. 결측값 대치 기법 완벽 정리</h4>\n<ul class='concept-block-ul'>\n  <li><strong>완전분석법 (Listwise Deletion):</strong> 결측치가 하나라도 있는 행을 통째로 삭제 (표본 크기 감소, 편향 위험).</li>\n  <li><strong>평균 대치법:</strong> 평균으로 채움 $\\to$ <strong>자료의 분산이 축소되고 변수 간 상관관계가 왜곡</strong>되는 치명적 단점.</li>\n  <li><strong>Hot Deck 대치:</strong> <strong>'현재 동일한 데이터셋'</strong> 내에서 유사한 특성을 가진 관측치의 값으로 대치.</li>\n  <li><strong>Cold Deck 대치:</strong> <strong>'외부 데이터셋'</strong>이나 과거 이력 데이터의 관측치로 대치.</li>\n  <li><strong>K-NN 대치:</strong> 결측치가 없는 변수들을 기준으로 가장 가까운 $K$개 이웃의 가중평균값으로 대치.</li>\n  <li><strong>다중 대치법 (MICE):</strong> 1) 대치(Imputation) $\\to$ 2) 분석(Analysis) $\\to$ 3) 결합(Pooling)의 3단계를 거쳐 결측값의 불확실성을 모형에 반영.</li>\n</ul>\n\n<div class='concept-block-note'>\n  💡 <strong>3초 암기 공식:</strong><br>\n  - <strong>MCAR = 아무 이유 없음 (완전 우연)</strong><br>\n  - <strong>MAR = 다른 변수 때문 (성별$\to$소득결측)</strong><br>\n  - <strong>MNAR = 자기 자신 값 때문 (고소득$\to$소득결측)</strong><br>\n  - <strong>Hot Deck = 현재 데이터에서 뽑기 / Cold Deck = 외부 데이터에서 뽑기</strong>\n</div>\n\n<div class='concept-block-quiz'>\n  <div class='concept-quiz-q'>⚡ <strong>출제자의 함정 & 자가진단 OX:</strong><br>\n  Q. Hot Deck 대치법은 외부의 다른 데이터베이스나 과거 조사 결과를 참조하여 결측값을 대치하는 방법이다. (O/X)</div>\n  <div class='concept-quiz-a'>\n  정답: <strong>X</strong> - 외부는 <strong>Cold Deck</strong>입니다! <strong>Hot Deck은 현재 분석 중인 동일 데이터셋</strong>에서 가장 유사한 관측치의 값을 가져와 대치합니다.\n  </div>\n</div>\n"
        },
        {
          "id": "c2-9",
          "title": "결측값 처리 방법",
    ...
    },
    {
      ...
      "cards": [
        ...
        {
          "id": "c2-12",
          "title": "차원축소 9대 기법 완벽 비교 (PCA·LDA·ICA·SVD·요인분석·MDS·t-SNE·UMAP·AutoEncoder)",
          "open": false,
          "content": "\n<h4 class='concept-block-h4'>1. 차원축소 알고리즘 9대 마스터 분류</h4>\n<div class='concept-keywords-row'>\n  <span class='concept-keyword-label'>🔑 핵심 키워드:</span>\n  <span class='concept-keyword-tag'>PCA (분산 최대)</span>\n  <span class='concept-keyword-tag'>LDA (클래스 분리)</span>\n  <span class='concept-keyword-tag'>ICA (독립성)</span>\n  <span class='concept-keyword-tag'>SVD (행렬분해)</span>\n  <span class='concept-keyword-tag'>요인분석 (잠재요인)</span>\n  <span class='concept-keyword-tag'>MDS (거리보존)</span>\n  <span class='concept-keyword-tag'>t-SNE (이웃시각화)</span>\n  <span class='concept-keyword-tag'>UMAP (위상구조+고속)</span>\n  <span class='concept-keyword-tag'>AutoEncoder (압축복원)</span>\n</div>\n\n<table class='concept-table' style='width:100%; border-collapse:collapse; margin:10px 0;'>\n  <thead>\n    <tr style='background:var(--bg-card-muted);'>\n      <th style='padding:8px; border:1px solid var(--border-color);'>기법</th>\n      <th style='padding:8px; border:1px solid var(--border-color);'>학습 유형</th>\n      <th style='padding:8px; border:1px solid var(--border-color);'>핵심 원리 및 목표</th>\n      <th style='padding:8px; border:1px solid var(--border-color);'>3초 킬러 키워드</th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>PCA</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>비지도 (선형)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>데이터의 <strong>분산(정보량)을 최대로 보존</strong>하는 서로 직교하는 주성분 축 탐색</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>분산 최대화 / 직교</strong></td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>LDA</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>지도 (선형)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>클래스 간 분산 최대화 / 클래스 내 분산 최소화</strong>로 분류 성능 극대화</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>클래스 분리 (지도학습)</strong></td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>ICA</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>비지도 (선형)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>혼합된 신호에서 <strong>통계적 독립성(Non-Gaussianity)</strong>을 최대화하여 분리 (음성 분리)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>독립 성분 / 비가우시안</strong></td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>SVD</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>비지도 (선형)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>임의의 $m \\times n$ 행렬을 $U \\Sigma V^T$로 직교 분해 (LSA 잠재의미분석, 추천시스템)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>특이값 분해 / 직교행렬</strong></td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>요인분석</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>비지도 (선형)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>변수들 간 상관관계를 분석하여 배후의 <strong>공통 잠재 요인(Latent Factor)</strong> 도출</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>잠재 요인 / 공통분산</strong></td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>MDS</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>비지도 (선/비선형)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>개체 간의 거리/유사도를 2D/3D 기하학적 공간 상의 <strong>거리로 보존</strong> (스트레스 값 최소화)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>거리 보존 / 스트레스</strong></td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>t-SNE</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>비지도 (비선형)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>t-분포 확률을 활용하여 <strong>국소적 이웃 유사도</strong>를 보존 (2D/3D 시각화 특화, 전역구조 한계)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>국소 이웃 / 고차원 시각화</strong></td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>UMAP</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>비지도 (비선형)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>위상수학/리만기하학 매니폴드 기반. <strong>국소 및 전역(Global) 구조를 동시 보존</strong>하며 t-SNE보다 대폭 빠름</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>전역+국소 보존 / 고속</strong></td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>AutoEncoder</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>자기지도 (신경망)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>입력 $\\to$ 인코더(잠재공간 압축) $\\to$ 디코더(복원) 신경망 구조를 통해 비선형 특징 추출</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>인코더-디코더 / 비선형 압축</strong></td>\n    </tr>\n  </tbody>\n</table>\n\n<div class='concept-block-note'>\n  💡 <strong>초간단 암기 키워드:</strong><br>\n  - <strong>PCA = 분산 (비지도)</strong><br>\n  - <strong>LDA = 클래스 구분 (지도)</strong><br>\n  - <strong>ICA = 독립 신호 (칵테일 파티)</strong><br>\n  - <strong>요인분석 = 잠재요인 (설문조사)</strong><br>\n  - <strong>t-SNE = 이웃 시각화 (국소)</strong><br>\n  - <strong>UMAP = 전역+국소 구조 보존 (빠름)</strong>\n</div>\n\n<div class='concept-block-quiz'>\n  <div class='concept-quiz-q'>⚡ <strong>출제자의 함정 & 자가진단 OX:</strong><br>\n  Q. 주성분 분석(PCA)과 선형 판별 분석(LDA)은 모두 타깃 레이블(정답)을 필요로 하는 지도학습 차원축소 기법이다. (O/X)</div>\n  <div class='concept-quiz-a'>\n  정답: <strong>X</strong> - <strong>PCA는 정답 라벨이 필요 없는 비지도학습</strong>이며, <strong>LDA는 클래스 라벨을 사용하는 지도학습</strong>입니다!\n  </div>\n</div>\n"
        },
        {
          "id": "c2-13",
    ...
    },
    {
      ...
      "cards": [
        {
          "id": "c2-20",
          "title": "표본추출 기법 완벽 비교 (단순랜덤·계통·층화·집락·부트스트랩)",
          "open": false,
          "content": "\n<h4 class='concept-block-h4'>1. 확률표본추출 4대 기법 & 부트스트랩</h4>\n<div class='concept-keywords-row'>\n  <span class='concept-keyword-label'>🔑 핵심 키워드:</span>\n  <span class='concept-keyword-tag'>단순무작위</span>\n  <span class='concept-keyword-tag'>계통추출(간격 k)</span>\n  <span class='concept-keyword-tag'>층화추출(각 층에서)</span>\n  <span class='concept-keyword-tag'>집락추출(군집 통째)</span>\n  <span class='concept-keyword-tag'>부트스트랩(63.2%/36.8%)</span>\n</div>\n\n<ul class='concept-block-ul'>\n  <li><strong>단순무작위추출 (Simple Random):</strong> 모집단의 모든 개체가 뽑힐 확률이 동일(임의 추출). 난수표/컴퓨터 난수 활용.</li>\n  <li><strong>계통추출 (Systematic):</strong> 간격 $k = N/n$ 설정 후, 첫 번째만 무작위 선정하고 이후 <strong>매 $k$번째</strong> 표본 추출. (주의: 모집단에 주기성이 있으면 편향 발생!)</li>\n  <li><strong>층화추출 (Stratified):</strong> 모집단을 동질적 층으로 분할 후 <strong>'각 층(그룹)에서'</strong> 무작위 추출. <strong>[집단 내 동질, 집단 간 이질]</strong>. 비례 층화(비율대로) vs 불비례 층화(분산 큰 층에서 더 많이).</li>\n  <li><strong>집락/군집추출 (Cluster):</strong> 모집단을 이질적 군집으로 분할 후 <strong>'군집 자체(통째로)'</strong>를 무작위 선택하여 전수조사. <strong>[집단 내 이질, 집단 간 동질]</strong>. 조사 비용/시간 절감.</li>\n  <li><strong>부트스트랩 (Bootstrap):</strong> $N$개 데이터에서 <strong>복원추출</strong>로 $N$개를 뽑음. 한 번도 뽑히지 않을 확률(OOB, Out-of-Bag) $\\approx 36.8\\%$, 약 $63.2\\%$의 고유 데이터가 학습에 사용됨.</li>\n</ul>\n\n<h4 class='concept-block-h4'>2. 층화추출 vs 집락추출 3초 비교표 (단골 1순위)</h4>\n<table class='concept-table' style='width:100%; border-collapse:collapse; margin:10px 0;'>\n  <thead>\n    <tr style='background:var(--bg-card-muted);'>\n      <th style='padding:8px; border:1px solid var(--border-color);'>비교 항목</th>\n      <th style='padding:8px; border:1px solid var(--border-color);'>층화표본추출 (Stratified)</th>\n      <th style='padding:8px; border:1px solid var(--border-color);'>집락/군집표본추출 (Cluster)</th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>추출 방식</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>모든 층의 내부에서 일부씩</strong> 추출</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>선택된 군집 전체(통째로)</strong> 전수조사</td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>집단 내 (Intra)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong style='color:var(--brand-dark);'>동질적 (Homogeneous)</strong></td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong style='color:var(--danger);'>이질적 (Heterogeneous)</strong></td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>집단 간 (Inter)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong style='color:var(--danger);'>이질적 (Heterogeneous)</strong></td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong style='color:var(--brand-dark);'>동질적 (Homogeneous)</strong></td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>주요 목적</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>표본의 대표성 향상, 추정 오차 최소화</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>조사 비용 및 시간 대폭 절감</td>\n    </tr>\n  </tbody>\n</table>\n\n<div class='concept-block-note'>\n  💡 <strong>한 문장 암기법:</strong><br>\n  - <strong>층화: 각 그룹에서 뽑는다 (집단 내 동질, 집단 간 이질)</strong><br>\n  - <strong>집락: 그룹 자체를 통째로 뽑는다 (집단 내 이질, 집단 간 동질)</strong>\n</div>\n\n<div class='concept-block-quiz'>\n  <div class='concept-quiz-q'>⚡ <strong>출제자의 함정 & 자가진단 OX:</strong><br>\n  Q. 계통추출법은 모집단에 일정한 주기성(Cycle)이 존재하는 경우에도 편향 없이 우수한 대표성을 보장한다. (O/X)</div>\n  <div class='concept-quiz-a'>\n  정답: <strong>X</strong> - 계통추출법의 가장 치명적인 약점은 <strong>모집단의 주기성과 추출 간격 k가 일치할 경우 극단적인 표본 편향이 발생</strong>한다는 점입니다!\n  </div>\n</div>\n"
        },
        {
          "id": "c2-21",
          "title": "확률분포의 종류",
    ...
    },
    {
      ...
      "cards": [
        {
          "id": "c3-1",
          "title": "선형회귀 4대 가정(선분정독)·다중공선성(VIF)·정규화(Lasso·Ridge·Elastic Net)",
          "open": false,
          "content": "\n<h4 class='concept-block-h4'>1. 선형회귀 4대 기본가정 (선·분·정·독)</h4>\n<div class='concept-keywords-row'>\n  <span class='concept-keyword-label'>🔑 핵심 키워드:</span>\n  <span class='concept-keyword-tag'>선형성</span>\n  <span class='concept-keyword-tag'>등분산성</span>\n  <span class='concept-keyword-tag'>정규성</span>\n  <span class='concept-keyword-tag'>독립성(Durbin-Watson)</span>\n  <span class='concept-keyword-tag'>다중공선성(VIF)</span>\n</div>\n\n<ul class='concept-block-ul'>\n  <li><strong>1) 선형성 (Linearity):</strong> 독립변수와 종속변수 간에 선형적 관계가 존재함. (산점도 확인)</li>\n  <li><strong>2) 등분산성 (Homoscedasticity):</strong> 잔차의 분산이 모든 독립변수 값에 대해 일정함. (잔차도, Breusch-Pagan 검정)</li>\n  <li><strong>3) 정규성 (Normality):</strong> 잔차의 분포가 평균 0인 정규분포를 따름. (Q-Q Plot 직선, Shapiro-Wilk 검정)</li>\n  <li><strong>4) 독립성 (Independence):</strong> 잔차들 간에 자기상관이 없음. (<strong>Durbin-Watson 통계량 $d \\approx 2$</strong>이면 독립, $0$에 가까우면 양의 상관, $4$에 가까우면 음의 상관)</li>\n</ul>\n\n<h4 class='concept-block-h4'>2. 다중공선성 (Multicollinearity) 진단 및 해결</h4>\n<ul class='concept-block-ul'>\n  <li><strong>진단:</strong> $VIF(분산팽창계수) = \\frac{1}{1 - R_j^2} \\ge 10$ 이면 심각한 다중공선성. 공차한계(Tolerance) $= 1 - R_j^2 < 0.1$.</li>\n  <li><strong>해결:</strong> 상관성 높은 변수 제거, 주성분 회귀(PCR), 능형회귀(Ridge) 또는 라쏘(Lasso) 적용.</li>\n</ul>\n\n<h4 class='concept-block-h4'>3. 정규화 규제 3총사 완벽 비교 (Lasso vs Ridge vs Elastic Net)</h4>\n<table class='concept-table' style='width:100%; border-collapse:collapse; margin:10px 0;'>\n  <thead>\n    <tr style='background:var(--bg-card-muted);'>\n      <th style='padding:8px; border:1px solid var(--border-color);'>구분</th>\n      <th style='padding:8px; border:1px solid var(--border-color);'>Lasso (L1 규제)</th>\n      <th style='padding:8px; border:1px solid var(--border-color);'>Ridge (L2 규제)</th>\n      <th style='padding:8px; border:1px solid var(--border-color);'>Elastic Net (L1 + L2)</th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>패널티 항</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>$\\lambda \\sum |\\beta_j|$ (가중치 절댓값 합)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>$\\lambda \\sum \\beta_j^2$ (가중치 제곱합)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>$\\lambda_1 \\sum |\\beta_j| + \\lambda_2 \\sum \\beta_j^2$</td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>제약 기하학</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>마름모꼴 (모서리 접촉)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>원형 / 구형</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>둥근 마름모형</td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>계수 축소</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong style='color:var(--brand-dark);'>일부 계수를 정확히 0으로 만듦</strong></td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>계수를 0에 가깝게 축소 (0은 안 됨)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>일부 0 생성 + 계수 축소</td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>주요 효과</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>변수 선택 (Feature Selection)</strong>, 희소 모델</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>다중공선성 완화</strong>, 안정적 계수 추정</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>상관성 높은 변수 그룹 선택</td>\n    </tr>\n  </tbody>\n</table>\n\n<div class='concept-block-note'>\n  💡 <strong>한 문장 암기:</strong><br>\n  - <strong>선형회귀 가정 = 선분정독 (선형성, 등분산성, 정규성, 독립성)</strong><br>\n  - <strong>Lasso = L1 = 변수 선택 (계수 0)</strong><br>\n  - <strong>Ridge = L2 = 계수 축소 (다중공선성 완화)</strong><br>\n  - <strong>Elastic Net = L1 + L2</strong>\n</div>\n\n<div class='concept-block-quiz'>\n  <div class='concept-quiz-q'>⚡ <strong>출제자의 함정 & 자가진단 OX:</strong><br>\n  Q. 릿지(Ridge) 회귀는 중요하지 않은 독립변수의 회귀계수를 완전히 0으로 만들어 자동으로 변수 선택(Feature Selection)을 수행한다. (O/X)</div>\n  <div class='concept-quiz-a'>\n  정답: <strong>X</strong> - 회귀계수를 완전히 0으로 만드는 것은 <strong>라쏘(Lasso, L1)</strong>입니다! 릿지(Ridge, L2)는 0에 가깝게 줄일 뿐 완전히 0으로 만들지는 못합니다.\n  </div>\n</div>\n"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "cards": [
        {
          "id": "c3-4",
          "title": "의사결정나무 분할 기준(CHAID·CART·C4.5) 및 정지규칙 vs 가지치기",
          "open": false,
          "content": "\n<h4 class='concept-block-h4'>1. 의사결정나무 노드 분할 알고리즘 매트릭스</h4>\n<div class='concept-keywords-row'>\n  <span class='concept-keyword-label'>🔑 핵심 키워드:</span>\n  <span class='concept-keyword-tag'>CHAID (카이제곱 / ANOVA F)</span>\n  <span class='concept-keyword-tag'>CART (지니계수 / 분산감소량)</span>\n  <span class='concept-keyword-tag'>C4.5 (엔트로피 / 정보이득비)</span>\n  <span class='concept-keyword-tag'>정지규칙 (사전중단)</span>\n  <span class='concept-keyword-tag'>가지치기 (사후제거)</span>\n</div>\n\n<table class='concept-table' style='width:100%; border-collapse:collapse; margin:10px 0;'>\n  <thead>\n    <tr style='background:var(--bg-card-muted);'>\n      <th style='padding:8px; border:1px solid var(--border-color);'>알고리즘</th>\n      <th style='padding:8px; border:1px solid var(--border-color);'>분류 나무 (이산형 목표변수)</th>\n      <th style='padding:8px; border:1px solid var(--border-color);'>회귀 나무 (연속형 목표변수)</th>\n      <th style='padding:8px; border:1px solid var(--border-color);'>분할 방식</th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>CHAID</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong style='color:var(--brand-dark);'>카이제곱($\\chi^2$) 통계량 (p-value)</strong></td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong style='color:var(--brand-dark);'>ANOVA F-통계량 (F-검정)</strong></td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>다지 분할 (Multi-way)</td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>CART</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong style='color:var(--danger);'>지니 계수 (Gini Index)</strong></td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong style='color:var(--danger);'>분산 감소량 (Variance Reduction)</strong></td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>이진 분할 (Binary)</td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>C4.5 / C5.0</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>엔트로피 / 정보이득비 (Gain Ratio)</strong></td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>미지원</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>다지 분할 (Multi-way)</td>\n    </tr>\n  </tbody>\n</table>\n\n<h4 class='concept-block-h4'>2. 정지규칙 (Stopping Rule) vs 가지치기 (Pruning)</h4>\n<ul class='concept-block-ul'>\n  <li><strong>정지규칙 (사전 제어):</strong> 나무의 추가 성장을 사전에 중단 (최대 트리 깊이 도달, 노드 내 최소 샘플 수 미달, 불순도 감소량 기준치 미달 등).</li>\n  <li><strong>가지치기 (사후 제어):</strong> 나무를 끝까지 키운 뒤(과적합 유발 상태), 검증 데이터셋을 활용해 일반화 성능을 저해하는 불필요한 하위 가지를 사후에 잘라냄 (비용-복잡도 가지치기).</li>\n</ul>\n\n<div class='concept-block-note'>\n  💡 <strong>시험장 1초 암기:</strong><br>\n  - <strong>분류 분할: CHAID 카이제곱 / CART 지니 / C4.5 엔트로피(정보이득비)</strong><br>\n  - <strong>회귀 분할: CHAID ANOVA F / CART 분산감소</strong><br>\n  - <strong>정지 = 자라기 전에 멈춤 / 가지치기 = 다 자란 후 자름</strong>\n</div>\n\n<div class='concept-block-quiz'>\n  <div class='concept-quiz-q'>⚡ <strong>출제자의 함정 & 자가진단 OX:</strong><br>\n  Q. CART 알고리즘은 목표변수가 연속형인 회귀나무 구축 시 노드 분할 기준으로 카이제곱 통계량을 사용한다. (O/X)</div>\n  <div class='concept-quiz-a'>\n  정답: <strong>X</strong> - CART 회귀나무는 <strong>분산 감소량(Variance Reduction)</strong>을 사용합니다! 카이제곱 통계량은 <strong>CHAID 분류나무</strong>의 기준입니다.\n  </div>\n</div>\n"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "cards": [
        ...
        {
          "id": "c3-12",
          "title": "시계열 분석 정상성 3대 조건 및 ACF·PACF 모형 식별 (AR·MA·ARIMA)",
          "open": false,
          "content": "\n<h4 class='concept-block-h4'>1. 시계열 정상성 (Stationarity) 3대 조건</h4>\n<div class='concept-keywords-row'>\n  <span class='concept-keyword-label'>🔑 핵심 키워드:</span>\n  <span class='concept-keyword-tag'>평균 일정(차분)</span>\n  <span class='concept-keyword-tag'>분산 일정(로그변환)</span>\n  <span class='concept-keyword-tag'>공분산은 시차에만 의존</span>\n  <span class='concept-keyword-tag'>ACF(MA식별)</span>\n  <span class='concept-keyword-tag'>PACF(AR식별)</span>\n</div>\n\n<ul class='concept-block-ul'>\n  <li><strong>1) 평균이 시간에 따라 일정:</strong> 추세가 있으면 비정상 $\\to$ <strong>차분(Differencing)</strong>으로 정상화.</li>\n  <li><strong>2) 분산이 시간에 따라 독립적이며 일정:</strong> 변동폭이 커지면 $\\to$ <strong>로그 변환(Log) 또는 Box-Cox 변환</strong>.</li>\n  <li><strong>3) 공분산은 특정 시점이 아닌 오직 시차(Lag, $k$)에만 의존:</strong> $Cov(Y_t, Y_{t+k}) = \\gamma_k$.</li>\n</ul>\n\n<h4 class='concept-block-h4'>2. ACF vs PACF 모형 식별 3초 법칙 (시험 100% 출제)</h4>\n<table class='concept-table' style='width:100%; border-collapse:collapse; margin:10px 0;'>\n  <thead>\n    <tr style='background:var(--bg-card-muted);'>\n      <th style='padding:8px; border:1px solid var(--border-color);'>시계열 모형</th>\n      <th style='padding:8px; border:1px solid var(--border-color);'>자기상관함수 (ACF)</th>\n      <th style='padding:8px; border:1px solid var(--border-color);'>편자기상관함수 (PACF)</th>\n      <th style='padding:8px; border:1px solid var(--border-color);'>차수 결정 방법</th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>자기회귀 AR(p)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>지수적 감소 또는 사인파 감쇠</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong style='color:var(--brand-dark);'>p차 시차 이후 절단 (0으로 급감)</strong></td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>PACF가 절단되는 시차 = p</strong></td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>이동평균 MA(q)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong style='color:var(--danger);'>q차 시차 이후 절단 (0으로 급감)</strong></td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>지수적 감소 또는 사인파 감쇠</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>ACF가 절단되는 시차 = q</strong></td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>ARMA(p, q)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>점진적 감쇠 (절단면 없음)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>점진적 감쇠 (절단면 없음)</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>둘 다 점진적 감소</td>\n    </tr>\n  </tbody>\n</table>\n\n<div class='concept-block-note'>\n  💡 <strong>시험장 3초 킬러 공식:</strong><br>\n  - <strong>AR $\to$ PACF $\to$ p차 절단 (앞글자: AR-PAC)</strong><br>\n  - <strong>MA $\to$ ACF $\to$ q차 절단 (앞글자: MA-AC)</strong><br>\n  - <strong>ARIMA(p, d, q)에서 d는 정상화에 필요한 차분(Differencing) 횟수!</strong>\n</div>\n\n<div class='concept-block-quiz'>\n  <div class='concept-quiz-q'>⚡ <strong>출제자의 함정 & 자가진단 OX:</strong><br>\n  Q. 어떤 정상 시계열의 ACF가 지수적으로 감쇠하고 PACF가 시차 2 이후 급격히 0으로 절단되었다면, 이 모형은 MA(2) 모형으로 식별된다. (O/X)</div>\n  <div class='concept-quiz-a'>\n  정답: <strong>X</strong> - <strong>PACF가 2차 이후 절단</strong>되었으므로 이 모형은 **AR(2)** 모형입니다! (MA(2)는 ACF가 2차 이후 절단됩니다).\n  </div>\n</div>\n"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "cards": [
        ...
        {
          "id": "c4-2",
          "title": "군집분석 수 결정 및 품질 평가 (Elbow Method vs Silhouette 계수)",
          "open": false,
          "content": "\n<h4 class='concept-block-h4'>1. 최적 군집 수 결정 vs 군집 품질 평가</h4>\n<div class='concept-keywords-row'>\n  <span class='concept-keyword-label'>🔑 핵심 키워드:</span>\n  <span class='concept-keyword-tag'>Elbow Method(군집수 k 결정)</span>\n  <span class='concept-keyword-tag'>SSE / WCSS(오차제곱합)</span>\n  <span class='concept-keyword-tag'>Silhouette(-1 ~ 1)</span>\n  <span class='concept-keyword-tag'>a(i) 군집내 응집도</span>\n  <span class='concept-keyword-tag'>b(i) 군집간 분리도</span>\n</div>\n\n<ul class='concept-block-ul'>\n  <li><strong>Elbow Method (엘보우 기법):</strong>\n    군집 수 $k$를 늘려가며 군집 내 오차제곱합(SSE / WCSS)을 측정할 때, <strong>감소 폭이 급격히 둔화되어 팔꿈치처럼 꺾이는 지점</strong>을 최적의 군집 수 $k$로 선택.</li>\n  <li><strong>실루엣 계수 (Silhouette Coefficient):</strong>\n    개별 관측치 $i$에 대해 군집 내 거리 평균 $a(i)$(응집도)와 가장 가까운 타 군집 거리 평균 $b(i)$(분리도)를 계산:\n    $$s(i) = \\frac{b(i) - a(i)}{\\max(a(i), b(i))}, \\quad -1 \\le s(i) \\le 1$$\n    - <strong>1에 가까울수록:</strong> 자신의 군집과 잘 뭉쳐있고 타 군집과 잘 떨어져 있음 (완벽한 군집화).<br>\n    - <strong>0 근처:</strong> 두 군집의 경계선에 위치함.<br>\n    - <strong>음수(-):</strong> 잘못된 군집에 할당됨.<br>\n    - 전체 평균 실루엣 값이 <strong>0.5 이상</strong>이면 군집 구조가 타당한 것으로 평가.\n  </li>\n</ul>\n\n<div class='concept-block-note'>\n  💡 <strong>3초 킬러 구분법:</strong><br>\n  - <strong>Elbow = 군집 수 $k$를 결정하는 기법 (SSE 꺾이는 팔꿈치 지점)</strong><br>\n  - <strong>Silhouette = 군집이 얼마나 잘 나뉘었는지 품질을 평가하는 지표 (-1 ~ +1)</strong>\n</div>\n\n<div class='concept-block-quiz'>\n  <div class='concept-quiz-q'>⚡ <strong>출제자의 함정 & 자가진단 OX:</strong><br>\n  Q. 실루엣 계수는 0에서 1 사이의 값을 가지며, 음수 값을 가질 수 없다. (O/X)</div>\n  <div class='concept-quiz-a'>\n  정답: <strong>X</strong> - 실루엣 계수의 범위는 <strong>-1부터 +1까지</strong>입니다! 데이터가 엉뚱한 군집에 잘못 들어간 경우 음수(-) 값을 가집니다.\n  </div>\n</div>\n"
        },
        {
          "id": "c4-3",
          "title": "분석모형 진단 및 검정",
    ...
    },
    {
      ...
      "cards": [
        ...
        {
          "id": "c5-9",
          "title": "앙상블 4대 기법 완벽 비교 (Voting·Bagging·Boosting·Stacking)",
          "open": false,
          "content": "\n<h4 class='concept-block-h4'>1. 앙상블 4대 패러다임 완벽 비교</h4>\n<div class='concept-keywords-row'>\n  <span class='concept-keyword-label'>🔑 핵심 키워드:</span>\n  <span class='concept-keyword-tag'>Voting(서로 다른 모델)</span>\n  <span class='concept-keyword-tag'>Bagging(병렬/분산감소)</span>\n  <span class='concept-keyword-tag'>Boosting(순차/편향감소)</span>\n  <span class='concept-keyword-tag'>Stacking(메타모델)</span>\n</div>\n\n<table class='concept-table' style='width:100%; border-collapse:collapse; margin:10px 0;'>\n  <thead>\n    <tr style='background:var(--bg-card-muted);'>\n      <th style='padding:8px; border:1px solid var(--border-color);'>기법</th>\n      <th style='padding:8px; border:1px solid var(--border-color);'>학습 방식</th>\n      <th style='padding:8px; border:1px solid var(--border-color);'>오차 감소 효과</th>\n      <th style='padding:8px; border:1px solid var(--border-color);'>대표 모델 및 특징</th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>Voting</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>동일 데이터 $\\to$ 서로 다른 모델 결합</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>분산 및 편향 안정화</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>Hard Voting(다수결) vs Soft Voting(확률평균)</td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>Bagging</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>복원추출(Bootstrap) $\\to$ <strong>병렬(Parallel) 독립 학습</strong></td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong style='color:var(--brand-dark);'>분산(Variance) 감소</strong></td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong>Random Forest</strong> (특성 무작위 추출 $\\to$ 트리 간 상관성 감소)</td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>Boosting</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>이전 오차에 가중치 부여 $\\to$ <strong>순차적(Sequential) 학습</strong></td>\n      <td style='padding:8px; border:1px solid var(--border-color);'><strong style='color:var(--danger);'>편향(Bias) 감소</strong></td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>AdaBoost, GBM, <strong>XGBoost</strong>(2차 미분/규제), <strong>LightGBM</strong>(Leaf-wise/고속)</td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid var(--border-color); font-weight:bold;'>Stacking</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>개별 모델 예측값 $\\to$ 메타 모델의 피처로 재학습</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>최고 성능 지향</td>\n      <td style='padding:8px; border:1px solid var(--border-color);'>Base Models $\\to$ Meta-Learner (Blender)</td>\n    </tr>\n  </tbody>\n</table>\n\n<div class='concept-block-note'>\n  💡 <strong>시험장 3초 킬러 암기법:</strong><br>\n  - <strong>배깅(Bagging) = 병렬(Parallel) = 분산(Variance) 감소</strong><br>\n  - <strong>부스팅(Boosting) = 순차(Sequential) = 편향(Bias) 감소 (과적합 주의)</strong><br>\n  - <strong>스태킹(Stacking) = 예측 결과를 메타 모델이 다시 학습</strong>\n</div>\n\n<div class='concept-block-quiz'>\n  <div class='concept-quiz-q'>⚡ <strong>출제자의 함정 & 자가진단 OX:</strong><br>\n  Q. 부스팅(Boosting) 알고리즘은 여러 약한 학습기를 독립적으로 병렬 학습시켜 모델의 분산(Variance)을 줄이는 데 초점을 맞춘다. (O/X)</div>\n  <div class='concept-quiz-a'>\n  정답: <strong>X</strong> - 병렬 학습 및 분산 감소는 <strong>배깅(Bagging)</strong>의 특징입니다! 부스팅은 <strong>순차적(Sequential) 학습</strong>을 통해 이전 오차를 줄이며 <strong>편향(Bias)을 감소</strong>시킵니다.\n  </div>\n</div>\n"
        },
        {
          "id": "c5-10",
    ...
    },
    {
      ...
      "cards": [
        ...
        {
          "id": "c3-13-2",
          "title": "어텐션 메커니즘·트랜스포머·BERT vs GPT & 옵티마이저 계보",
          "open": false,
          "content": "\n<h4 class='concept-block-h4'>1. 어텐션 & 트랜스포머 핵심 원리</h4>\n<div class='concept-keywords-row'>\n  <span class='concept-keyword-label'>🔑 핵심 키워드:</span>\n  <span class='concept-keyword-tag'>Attention($Q,K,V$)</span>\n  <span class='concept-keyword-tag'>Positional Encoding</span>\n  <span class='concept-keyword-tag'>BERT(양방향/인코더/MLM)</span>\n  <span class='concept-keyword-tag'>GPT(단방향/디코더/생성)</span>\n  <span class='concept-keyword-tag'>Adam(모멘텀+RMSProp)</span>\n</div>\n\n<ul class='concept-block-ul'>\n  <li><strong>Attention 메커니즘:</strong> 질의(Query)와 모든 키(Key) 간의 유사도를 구해 가중치를 계산하고 값(Value)과 가중합 ($Attention(Q,K,V) = \\text{softmax}(\\frac{QK^T}{\\sqrt{d_k}})V$).</li>\n  <li><strong>Transformer:</strong> RNN의 순차 연산 한계를 극복하고 Positional Encoding과 Multi-Head Self-Attention으로 <strong>완벽한 병렬 학습</strong> 실현.</li>\n  <li><strong>BERT:</strong> Transformer <strong>Encoder</strong> 기반, <strong>양방향(Bidirectional)</strong> 문맥 학습, MLM([MASK] 빈칸 예측) + NSP, <strong>자연어 이해(NLU)</strong> 특화.</li>\n  <li><strong>GPT:</strong> Transformer <strong>Decoder</strong> 기반, <strong>일방향(Autoregressive)</strong> 좌$\\to$우 학습, 다음 단어 예측, <strong>자연어 생성(NLG)</strong> 특화.</li>\n</ul>\n\n<h4 class='concept-block-h4'>2. 경사하강법 옵티마이저(Optimizer) 계보</h4>\n<ul class='concept-block-ul'>\n  <li><strong>SGD:</strong> 미니배치 무작위 추출 $\\to$ 손실함수 기울기 방향으로 이동 (진동 심함).</li>\n  <li><strong>Momentum:</strong> 관성(이전 이동량)을 반영하여 안장점 및 진동 탈출 가속.</li>\n  <li><strong>AdaGrad:</strong> 자주 등장한 가중치는 학습률을 줄이고, 드문 가중치는 크게 조절 (후반부 학습 중단 문제).</li>\n  <li><strong>RMSProp:</strong> AdaGrad의 학습 정체 문제를 지수이동평균(EMA) 감쇠율로 해결.</li>\n  <li><strong>Adam (Adaptive Moment Estimation):</strong> <strong>Momentum(방향/1차 모멘텀) + RMSProp(보폭/2차 모멘텀)</strong>을 결합한 사실상 표준 옵티마이저.</li>\n</ul>\n\n<div class='concept-block-note'>\n  💡 <strong>시험장 3초 킬러 암기:</strong><br>\n  - <strong>BERT = Encoder = 양방향 = 빈칸 예측 (이해 특화)</strong><br>\n  - <strong>GPT = Decoder = 단방향 = 다음 단어 생성 (생성 특화)</strong><br>\n  - <strong>Adam = Momentum(방향) + RMSProp(보폭)</strong>\n</div>\n\n<div class='concept-block-quiz'>\n  <div class='concept-quiz-q'>⚡ <strong>출제자의 함정 & 자가진단 OX:</strong><br>\n  Q. BERT 모델은 트랜스포머의 디코더(Decoder) 구조를 기반으로 하며, 단방향 자기회귀(Autoregressive) 방식으로 다음 단어를 생성한다. (O/X)</div>\n  <div class='concept-quiz-a'>\n  정답: <strong>X</strong> - 설명은 <strong>GPT</strong>에 해당합니다! <strong>BERT는 인코더(Encoder) 기반의 양방향(Bidirectional)</strong> 모델입니다.\n  </div>\n</div>\n"
        }
      ]
    },
    {
