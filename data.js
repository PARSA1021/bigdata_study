    ...
    },
    {
      ...
      "cards": [
        ...
        },
        {
          ...
          "title": "상관관계 분석",
          "open": false,
          "content": "<h4 class='concept-block-h4'>상관분석의 유형 및 방법</h4><div class='concept-keywords-row'><span class='concept-keyword-label'>🔑 핵심 키워드:</span> <span class='concept-keyword-tag'>단순상관분석</span><span class='concept-keyword-tag'>다중상관분석</span><span class='concept-keyword-tag'>편상관관계분석</span><span class='concept-keyword-tag'>피어슨 상관분석</span><span class='concept-keyword-tag'>스피어만 상관분석</span></div><ul class='concept-block-ul'><li><strong>단순상관분석:</strong> 두 개의 변수가 어느 정도 강한 관계에 있는가를 측정</li><li><strong>다중상관분석:</strong> 3개 이상의 변수 간 관계를 측정</li><li><strong>편상관관계분석:</strong> 제3의 변수를 통제한 상태에서 두 변수의 상관관계를 분석</li><li><strong>피어슨 상관분석:</strong> 양적 척도, 연속형 변수, 선형관계 크기 측정</li><li><strong>스피어만 상관분석:</strong> 서열 척도, 순서형 변수, 선형/비선형적 관계 나타냄 (X와 Y가 선형 관계가 아니더라도 +1 혹은 -1이 될 수 있음)</li></ul>"
        },
        {
          "id": "c2-17",
          "title": "기초통계량 추출 및 이해",
